...
$sql="SELECT id FROM passengers WHERE id='$userid'";
    ...
    if (mysqli_num_rows($result) == 1) {
        $sql = "UPDATE passengers SET currentlat='$currlatitude', currentlong='$currlongitude', destlat='$destlatitude', destlong='$destlongitude' WHERE id='$userid'";

        mysqli_query($link, $sql);
        
    } else {
        $sql = "INSERT INTO passengers (id, currentlat, currentlong, destlat, destlong)
