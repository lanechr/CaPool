                ...
                <div id="logo">
                    ...
                    <?php
                      if (isset($_SESSION['FBID'])) {
                          echo "<div id='loggedInUserFBImg'></div>";
                       }
                    ?>
                </div>
            </nav>
        ...
        <div id="loginOverlay" class="overlay">
            ...
            <form id="loginform" method="POST" action="loginaction.php">
                ...
                ?>
                    ...
                    <button class="btn waves-effect waves-light small" type="submit" name="action">
                        <p class="buttonSubmit">Log In</p>
